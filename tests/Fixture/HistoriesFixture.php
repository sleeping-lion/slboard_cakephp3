...
class HistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'year' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'index_histories_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            ...
            'count' => 1,
            'enable' => 1,
            'created_at' => '2015-04-15 01:58:18',
            'updated_at' => '2015-04-15 01:58:18'
        ],
    ];
}
