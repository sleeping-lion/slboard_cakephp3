...
class BlogCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'index_blog_comments_on_blog_id' => ['type' => 'index', 'columns' => ['blog_id'], 'length' => []],
            'index_blog_comments_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            ...
            'created_at' => '2015-04-15 01:57:37',
            'updated_at' => '2015-04-15 01:57:37'
        ],
    ];
}
