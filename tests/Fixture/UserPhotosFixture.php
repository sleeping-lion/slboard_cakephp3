...
class UserPhotosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'alt' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'index_user_photos_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            ...
            'default' => 1,
            'enable' => 1,
            'created_at' => '2015-04-15 01:59:10',
            'updated_at' => '2015-04-15 01:59:10'
        ],
    ];
}
