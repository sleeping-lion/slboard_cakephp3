...
class GalleriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gallery_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'index_galleries_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'index_galleries_on_gallery_category_id' => ['type' => 'index', 'columns' => ['gallery_category_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'count' => 1,
            'enable' => 1,
            'created_at' => '2015-05-12 09:20:55',
            'updated_at' => '2015-05-12 09:20:55'
        ],
    ];
}
