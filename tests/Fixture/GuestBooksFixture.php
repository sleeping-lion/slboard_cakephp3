 ...
 *
 */
class GuestBooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'guest_book_comments_count' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'index_guest_books_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            ...
            'guest_book_comments_count' => 1,
            'count' => 1,
            'enable' => 1,
            'created_at' => '2015-04-15 01:57:00',
            'updated_at' => '2015-04-15 01:57:00'
        ],
    ];
}
