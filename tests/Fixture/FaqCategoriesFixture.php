...
class FaqCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'faqs_count' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'index_faq_categories_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'index_faq_categories_on_title' => ['type' => 'unique', 'columns' => ['title'], 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_unicode_ci'
    ...
    public $records = [
        [
            ...
            'faqs_count' => 1,
            'enable' => 1,
            'created_at' => '2015-04-15 01:56:25',
            'updated_at' => '2015-04-15 01:56:25'
        ],
    ];
}
